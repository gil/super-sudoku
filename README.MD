...
- **Generate Sudoku**: New button to generate sudokus for various difficulties.
- **Import Sudoku**: New button to import sudoku into a collection.
- **IndexedDB**: We now support much larger collections.
